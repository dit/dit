...
def test_to_pdf():
    ...
    with open(os.devnull, 'w') as fp:
        error = subprocess.call('pdflatex --help', shell=True, stdout=fp, stderr=fp)  # noqa: S607
        error |= subprocess.call('pdfcrop --help', shell=True, stdout=fp, stderr=fp)  # noqa: S607
