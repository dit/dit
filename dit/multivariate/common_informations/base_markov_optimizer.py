...
class MarkovVarMixin:
    ...
    def __init__(self, dist, rvs=None, crvs=None, bound=None, rv_mode=None):
        ...
        self._pmf_to_match = _copy_array(self._pmf)
    ...
    def construct_joint(self, x):
        ...
        joint = _moveaxis(joint, 1, -1)  # move crvs
        joint = _moveaxis(joint, 1, -1)  # move W
    ...
    def construct_full_joint(self, x):
        ...
        joint = _moveaxis(joint, self._n + 1, -1)  # move crvs
        joint = _moveaxis(joint, self._n + 1, -1)  # move W
        return joint
